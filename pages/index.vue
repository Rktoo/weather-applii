    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center space-y-8">
        ...
        <p class="text-xl max-w-2xl mx-auto"
           :class="themeStore.isDark ? 'text-gray-400' : 'text-white/90'">
        ...
        <form @submit.prevent="searchCity" class="max-w-xl mx-auto relative">
          ...
          >
            <div 
              ...
              class="absolute z-20 w-full mt-2 rounded-2xl shadow-xl overflow-hidden"
              :class="themeStore.isDark 
            ...
            >
              <div class="max-h-80 overflow-y-auto">
                <button
                  ...
                  type="button"
                  class="w-full px-6 py-4 text-left transition-all duration-200 flex items-center gap-3"
                  :class="themeStore.isDark 
                ...
                >
                  <MapPin 
                    :size="20" 
                    :class="themeStore.isDark ? 'text-cyan-400' : 'text-blue-600'"
                  />
                  <div class="flex-1">
          ...
          <!-- Error message -->
          <div v-if="searchError" class="mt-4 p-4 rounded-lg flex items-start gap-3"
               :class="themeStore.isDark 
  ...
  <section class="pt-10 pb-20">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-12">
        ...
        <p class="text-xl"
           :class="themeStore.isDark ? 'text-gray-400' : 'text-white/80'">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div
          ...
          :key="index"
          class="p-6 rounded-2xl transition-all duration-300 hover:shadow-2xl"
          :class="themeStore.isDark 
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Consultez la météo de n\'importe quelle ville dans le monde' }
  ]
})
</script>